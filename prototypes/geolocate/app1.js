...
*/
  ...
  $("#search-cuisine").on("change", function(event) {
    ...
    function render(pos) {
       ...
       //console.log(userLatitude);
       //console.log(userLongitude);
       var restaurantQueryURL = restaurantQueryURLBase + '&lat=' + userLatitude + '&lon=' + userLongitude + '&cuisines=' + searchCuisine 
     +'&count=' + numResults;
    ...
    searchCuisine = $('#search-cuisine').val();
      ...
      console.log(userLatitude);
      console.log("outside")
    //var restaurantQueryURL = restaurantQueryURLBase + '&lat=' + userLatitude + '&lon=' + userLongitude + '&radius=' + searchRadius + '&cuisines=' + searchCuisine 
    // +'&count=' + numResults;
    //console.log(restaurantQueryURL);
